...
public:
  ...
  static void EvoTest(Problem *problem, std::string test_id, int popSize,
                      int Xp, int Mp, int turSize, int elitesNum, int MUT_ID,
                      int CROSS_ID);
  ...
  static void SATest(Problem *problem, std::string test_id, float startTemp,
